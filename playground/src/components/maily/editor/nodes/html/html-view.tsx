  ...
  return (
    ...
    >
      {activeTab === "code" && (
        <pre
          className={cn(
            "my-0 rounded-lg border border-border bg-background p-2 text-foreground [&_code]:bg-transparent [&_code]:text-inherit"
          )}
        >
      ...
      {activeTab === "preview" && (
        <div
          className={cn(
            "not-prose rounded-lg border border-border p-2",
            isEmpty && "min-h-[42px]"
          )}
          ref={(node) => {
