...
import { Inbox, Send, FileText, AlertCircle, Pencil, Search, Loader2, Star, Paperclip, Archive, ShieldAlert, Trash2, MailOpen, Printer, ExternalLink, Smile, Reply, MoreVertical, Forward, Ban, Flag, Filter, Languages, Download, Code2 } from "lucide-react";
              ...
              <InputGroup className="bg-muted/30 h-8">
                ...
                {refreshing && (
                  <InputGroupAddon align="inline-end">
                    <Loader2 className="size-4 animate-spin" aria-label={t('refresh')} />
                  </InputGroupAddon>
                )}
              </InputGroup>
            </div>
